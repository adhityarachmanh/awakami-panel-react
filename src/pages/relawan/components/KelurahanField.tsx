...
const KelurahanField = () => {
  const { values } = useFormikContext<RelawanFormModel>();
        ...
        <Autocomplete
          ...
          renderInput={(params) => (
            <TextField
              ...
              error={form.touched.kelurahanId && Boolean(form.errors.kelurahanId)}
              helperText={form.touched.kelurahanId && form.errors.kelurahanId}
            />
          )}
        />
      )}
